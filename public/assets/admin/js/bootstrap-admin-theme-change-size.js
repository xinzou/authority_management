$(function() {
    ...
    $('.size-changer', sizeChangerContainer).on('click', function() {
        ...
        if (setLargeSize) {
            $('link[href="/assets/admin/css/bootstrap-admin-theme-small.css"]').remove();
            $('link[href="/assets/admin/css/bootstrap-small.css"]').remove();

            $('.small', sizeChangerContainer).removeClass('active');
            return true;
        }

        $('head').append('<link rel="stylesheet" media="screen" href="/assets/admin/css/bootstrap-small.css"><link rel="stylesheet" media="screen" href="/assets/admin/css/bootstrap-admin-theme-small.css">');
